...
# Creates players, manages personal identifiable information
class Player
  ...
  def action
    ...
    while true
      ...
      break if (placement_request.to_i.is_a? Numeric) && placement_request.to_i.between?(1, 9)
  ...
  def self.fetch_player_one_pii
    ...
    while true
      ...
      break if player_one_piece.eql?('X') || player_one_piece.eql?('O')
