...
class Player
    ...
    def self.fetch_player_one_pii
        ...
        player_one_pii[:player_one_name] = player_one_name
        player_one_pii[:player_one_piece] = player_one_piece
        player_one_pii
    end
    
    def self.fetch_player_two_pii(player_one_pii)
        player_one_name = player_one_pii[:player_one_name]
        player_one_piece = player_one_pii[:player_one_piece]
        ...
        player_two_pii = {}
        player_two_pii[:player_two_name] = player_two_name
        player_two_pii[:player_two_piece] = player_two_piece
